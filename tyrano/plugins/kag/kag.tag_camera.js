...
tyrano.plugin.kag.tag.camera = {
  ...
  start: function (pm) {
    ...
    */
    ...
    const to_camera = $.extend(true, {}, this.kag.stat.current_camera[pm.layer]);
    ...
    if (pm.layer == "layer_camera") {
      ...
      const layer_fore = $("." + pm.layer + "_fore");
      layer_fore.css("-webkit-transform-origin", "center center");
      layer_fore.a3d(a3d_define);
...
カメラ操作
:title
Wait for the camera movement to Complete
:exp
...
tyrano.plugin.kag.tag.mask = {
  ...
  start: function (pm) {
    ...
    const j_div = $("<div class='layer layer_mask' data-effect='" + pm.effect + "' style='z-index:100000000;position:absolute;'>");
