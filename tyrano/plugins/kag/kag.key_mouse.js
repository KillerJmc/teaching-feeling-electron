 ...
 *     Press [Esc] to hide the message window.
 * Mouse:
...
tyrano.plugin.kag.key_mouse = {
      ...
      layer_obj_click.swipe(
        {
          swipe: function (event, direction, distance, duration, fingerCount, fingerData) {
            ...
            const swipe_str = "swipe_" + direction + "_" + fingerCount;
  ...
  canClick: function () {
    return $(".layer_event_click").css("display") != "none" && $(".layer_menu").css("display") == "none";
  },
  ...
  canShowMenu: function () {
    ...
    //wait中の時
    return this.kag.stat.is_wait != true;
...
/*
 ...
 ///マウス周り
 //スライドイベント
 layer_obj_click.on('touchstart', function(e) {
 ...
 //スライドイベント
 layer_obj_click.on('touchend', function(e) {
